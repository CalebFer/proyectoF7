<template>
  <f7-page class="color-theme-orange">
    <f7-navbar class="navbar color-theme-deeppurple">
      ...
      <f7-nav-right>
        <f7-link icon-if-ios="f7:comment" icon-if-md="material:comment" panel-open="right"></f7-link>
        <f7-button panel-open="right">Po</f7-button>
      </f7-nav-right>
    </f7-navbar>
    <f7-toolbar>
    ...
    <f7-block strong class="color-theme-orange">
      <f7-row>
        <f7-col width="50">
